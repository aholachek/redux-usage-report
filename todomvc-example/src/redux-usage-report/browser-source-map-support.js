...
;(undefined.define || function (N, O) {
  ...
  ;(function b(q, v, h) {
    ...
    for (var k = "function" == typeof require && require, n = 0; n < h.length; n++) {
      e(h[n]);
    }return e;
  })({
    1: [function (q, v, h) {
    ...
    4: [function (q, v, h) {
      function b(f, g, w) {
        ...
        var a = typeof f === "undefined" ? "undefined" : (0, _typeof3.default)(f);
        if ("base64" === g && "string" === a) for (f = f.trim ? f.trim() : f.replace(/^\s+|\s+$/g, ""); 0 !== f.length % 4;) {
          f += "=";
        }if ("number" === a) var c = D(f);else if ("string" === a) c = b.byteLength(f, g);else if ("object" === a) c = D(f.length);else throw Error("First argument needs to be a number, array or string.");
        if (b._useTypedArrays) var d = b._augment(new Uint8Array(c));else d = this, d.length = c, d._isBuffer = !0;
        if (b._useTypedArrays && "number" === typeof f.byteLength) d._set(f);else {
          var m = f;
          if (M(m) || b.isBuffer(m) || m && "object" === (typeof m === "undefined" ? "undefined" : (0, _typeof3.default)(m)) && "number" === typeof m.length) for (g = 0; g < c; g++) {
            b.isBuffer(f) ? d[g] = f.readUInt8(g) : d[g] = f[g];
          } else if ("string" === a) d.write(f, 0, g);else if ("number" === a && !b._useTypedArrays && !w) for (g = 0; g < c; g++) {
            d[g] = 0;
          }
        }
        return d;
      ...
      function k(f, g, w, a) {
        ...
        a = f.length;
        if (!(g >= a)) return w ? (w = f[g], g + 1 < a && (w |= f[g + 1] << 8)) : (w = f[g] << 8, g + 1 < a && (w |= f[g + 1])), w;
      }
      function n(f, g, a, c) {
      ...
      function a(f, g, w, a) {
        ...
        if (!(g >= f.length)) return f = n(f, g, w, !0), f & 2147483648 ? -1 * (4294967295 - f + 1) : f;
      }
      function l(f, g, a, c) {
      ...
      function r(f, g, a, c, b) {
        ...
        var w = f.length;
        if (!(a >= w)) for (b = 0, w = Math.min(w - a, 2); b < w; b++) {
      ...
      function t(f, g, a, c, b) {
        ...
        var w = f.length;
        if (!(a >= w)) for (b = 0, w = Math.min(w - a, 4); b < w; b++) {
      ...
      function L(f) {
        for (var g = [], a = 0; a < f.length; a++) {
          ...
          if (127 >= c) g.push(f.charCodeAt(a));else {
            var b = a;
            55296 <= c && 57343 >= c && a++;
      ...
      b.concat = function (f, a) {
        ...
        var g;
        if ("number" !== typeof a) for (g = a = 0; g < f.length; g++) {
          a += f[g].length;
        }var c = new b(a),
            d = 0;
      ...
      b.prototype.copy = function (f, a, c, d) {
        ...
        d || 0 === d || (d = this.length);
        a || (a = 0);
        if (d !== c && 0 !== f.length && 0 !== this.length) if (p(d >= c, "sourceEnd < sourceStart"), p(0 <= a && a < f.length, "targetStart out of bounds"), p(0 <= c && c < this.length, "sourceStart out of bounds"), p(0 <= d && d <= this.length, "sourceEnd out of bounds"), d > this.length && (d = this.length), f.length - a < d - c && (d = f.length - a + c), d -= c, 100 > d || !b._useTypedArrays) for (var g = 0; g < d; g++) {
          f[g + a] = this[g + c];
      ...
      b.prototype.fill = function (a, c, b) {
        ...
        p(b >= c, "end < start");
        if (b !== c && 0 !== this.length) for (p(0 <= c && c < this.length, "start out of bounds"), p(0 <= b && b <= this.length, "end out of bounds"); c < b; c++) {
          this[c] = a;
        }
      };
      ...
      ;(function (b) {
        ...
        h.normalize = function (a) {
          var b = h.isAbsolute(a),
              u = "/" === d(a, -1);(a = e(k(a.split("/"), function (a) {
            return !!a;
          }), !b).join("/")) || b || (a = ".");
          a && u && (a += "/");
          return (b ? "/" : "") + a;
        ...
        h.relative = function (a, b) {
          ...
          for (var l = d(a.split("/")), t = d(b.split("/")), e = Math.min(l.length, t.length), c = e, m = 0; m < e; m++) {
            if (l[m] !== t[m]) {
              c = m;
              break;
            }
      ...
      q.nextTick = function () {
        ...
        if ("undefined" !== typeof window && window.postMessage && window.addEventListener) {
          ...
          window.addEventListener("message", function (e) {
            var k = e.source;k !== window && null !== k || "process-tick" !== e.data || (e.stopPropagation(), 0 < b.length && b.shift()());
          }, !0);
          return function (e) {
            b.push(e);
    ...
    8: [function (q, v, h) {
      function b() {
        this._array = [];
        this._set = n ? new _map2.default() : (0, _create2.default)(null);
      }
      var e = q("./util"),
          k = Object.prototype.hasOwnProperty,
          n = "undefined" !== typeof _map2.default;
      ...
      b.prototype.size = function () {
        return n ? this._set.size : (0, _getOwnPropertyNames2.default)(this._set).length;
      };
      b.prototype.add = function (b, a) {
        var d = n ? b : e.toSetString(b),
            u = n ? this.has(b) : k.call(this._set, d),
            r = this._array.length;u && !a || this._array.push(b);
    ...
    14: [function (q, v, h) {
      ...
      function n(a, e) {
        ...
        this._sections = c.map(function (a) {
          ...
          var c = d.getArg(a, "offset"),
              m = d.getArg(c, "line"),
              l = d.getArg(c, "column");
          if (m < t.line || m === t.line && l < t.column) throw Error("Section offsets must be ordered and non-overlapping.");
          t = c;
          return {
      ...
      b.prototype.allGeneratedPositionsFor = function (b) {
        ...
        if (0 <= c) {
          ...
          if (void 0 === b.column) for (e = t.originalLine; t && t.originalLine === e;) {
            m.push({
          ...
          } else for (b = t.originalColumn; t && t.originalLine === e && t.originalColumn == b;) {
            m.push({
              line: d.getArg(t, "generatedLine", null),
              column: d.getArg(t, "generatedColumn", null),
              lastColumn: d.getArg(t, "lastGeneratedColumn", null)
      ...
      e.prototype = (0, _create2.default)(b.prototype);
      e.prototype.consumer = b;
      e.fromSourceMap = function (a, b) {
        var c = (0, _create2.default)(e.prototype),
        ...
        c.file = a._file;
        c._sourceMapURL = b;
        for (var u = a._mappings.toArray().slice(), z = c.__generatedMappings = [], n = c.__originalMappings = [], h = 0, q = u.length; h < q; h++) {
          var v = u[h],
              B = new k();
      ...
      e.prototype._parseMappings = function (a, b) {
        for (var c = 1, m = 0, e = 0, t = 0, l = 0, z = 0, n = a.length, h = 0, q = {}, v = {}, G = [], H = [], A, F, p, E, I; h < n;) {
          if (";" === a.charAt(h)) c++, h++, m = 0;else if ("," === a.charAt(h)) h++;else {
            A = new k();
            A.generatedLine = c;
            for (E = h; E < n && !this._charIsMappingSeparator(a, E); E++) {}
            F = a.slice(h, E);
            if (p = q[F]) h += F.length;else {
              for (p = []; h < E;) {
      ...
      e.prototype._findMapping = function (b, d, c, m, e, l) {
        ...
        if (0 > b[m]) throw new TypeError("Column must be greater than or equal to 0, got " + b[m]);
      ...
      e.prototype.sourceContentFor = function (a, b) {
        ...
        for (e = 0; e < m.length; ++e) {
          if (m[e] == a) return this.sourcesContent[e];
        }var l;
        if (null != this.sourceRoot && (l = d.urlParse(this.sourceRoot))) {
          m = c.replace(/^file:\/\//, "");
          if ("file" == l.scheme && this._sources.has(m)) return this.sourcesContent[this._sources.indexOf(m)];
      ...
      n.prototype = (0, _create2.default)(b.prototype);
      ...
      n.prototype._parseMappings = function (a, b) {
        ...
        for (var c = 0; c < this._sections.length; c++) {
          for (var m = this._sections[c], e = m.consumer._generatedMappings, l = 0; l < e.length; l++) {
            var u = e[l],
    ...
    15: [function (q, v, h) {
      ...
      b.fromSourceMap = function (a) {
        ...
        a.eachMapping(function (a) {
          ...
          null != a.source && (b.source = a.source, null != d && (b.source = k.relative(d, b.source)), b.original = { line: a.originalLine, column: a.originalColumn }, null != a.name && (b.name = a.name));
          e.addMapping(b);
        });
      ...
      b.prototype.setSourceContent = function (a, b) {
        ...
        null != b ? (this._sourcesContents || (this._sourcesContents = (0, _create2.default)(null)), this._sourcesContents[k.toSetString(d)] = b) : this._sourcesContents && (delete this._sourcesContents[k.toSetString(d)], 0 === (0, _keys2.default)(this._sourcesContents).length && (this._sourcesContents = null));
      };
      ...
      b.prototype._validateMapping = function (a, b, d, e) {
        ...
        if (!(a && "line" in a && "column" in a && 0 < a.line && 0 <= a.column && !b && !d && !e || a && "line" in a && "column" in a && b && "line" in b && "column" in b && 0 < a.line && 0 <= a.column && 0 < b.line && 0 <= b.column && d)) throw Error("Invalid mapping: " + (0, _stringify2.default)({ generated: a, source: d, original: b, name: e }));
      };
      b.prototype._serializeMappings = function () {
        for (var a = 0, b = 1, d = 0, h = 0, n = 0, q = 0, c = "", m, y, C, D = this._mappings.toArray(), v = 0, K = D.length; v < K; v++) {
          y = D[v];
          m = "";
          if (y.generatedLine !== b) for (a = 0; y.generatedLine !== b;) {
            m += ";", b++;
          } else if (0 < v) {
    ...
    16: [function (q, v, h) {
      ...
      b.fromStringWithSourceMap = function (d, a, e) {
        function l(a, c) {
          if (null === a || void 0 === a.source) h.add(c);else {
        ...
        var h = new b(),
          ...
          return a + b;
            ...
            C = null;
        a.eachMapping(function (a) {
          if (null !== C) if (m < a.generatedLine) l(C, c()), m++, y = 0;else {
            var b = t[q] || "",
      ...
      b.prototype.walkSourceContents = function (b) {
        ...
        }var e = (0, _keys2.default)(this.sourceContents);
        a = 0;
      ...
      b.prototype.toStringWithSourceMap = function (b) {
        ...
        this.walk(function (b, e) {
          ...
          null !== e.source && null !== e.line && null !== e.column ? (q === e.source && c === e.line && m === e.column && y === e.name || h.addMapping({
            ...
            name: e.name
          }), q = e.source, c = e.line, m = e.column, y = e.name, n = !0) : n && (h.addMapping({ generated: { line: d, column: k } }), q = null, n = !1);
    ...
    17: [function (q, v, h) {
      ...
      q = !("__proto__" in (0, _create2.default)(null));
      h.toSetString = q ? d : a;
    ...
    19: [function (q, v, h) {
      ;(function (b, e) {
        ...
        function a(a) {
          ...
          if (!b) {
            var c = E(a.source);
            c ? (b = G[a.source] = { url: c.url, map: new y(c.map) }, b.map.sourcesContent && b.map.sources.forEach(function (a, c) {
        ...
        function l(b) {
          ...
          return c ? (b = a({ source: c[2], line: +c[3], column: c[4] - 1 }), "eval at " + c[1] + " (" + b.source + ":" + b.line + ":" + (b.column + 1) + ")") : (c = /^eval at ([^(]+) \((.+)\)$/.exec(b)) ? "eval at " + c[1] + " (" + l(c[2]) + ")" : b;
        }
        function u() {
          var a = "";
        ...
        function r(a) {
          var b = {};
          (0, _getOwnPropertyNames2.default)((0, _getPrototypeOf2.default)(a)).forEach(function (c) {
        ...
        var y = q("source-map").SourceMapConsumer,
            C = q("path");
        try {
          var D = q("fs");D.existsSync && D.readFileSync || (D = null);
        } catch (I) {}
        var M = !1,
            K = !1,
            L = !1,
        ...
        h.install = function (a) {
          ...
          !K && ("handleUncaughtExceptions" in a ? a.handleUncaughtExceptions : 1) && "object" === (typeof b === "undefined" ? "undefined" : (0, _typeof3.default)(b)) && null !== b && "function" === typeof b.on && (K = !0, m());
        };
